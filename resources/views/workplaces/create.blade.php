...
@section('title', 'Neuen Arbeitsplatz hinzufügen')

@section('content')
<h1>Neuen Arbeitsplatz hinzufügen</h1>
...
<form action="{{ route('workplaces.store') }}" method="POST">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="number" step="0.1" class="form-control @error('default_distance_km') is-invalid @enderror" 
                       id="default_distance_km" name="default_distance_km" value="{{ old('default_distance_km') }}" required>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('default_cost_per_km') is-invalid @enderror" 
                       id="default_cost_per_km" name="default_cost_per_km" value="{{ old('default_cost_per_km', '0.70') }}" required>
                @error('default_cost_per_km')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <div class="form-text">Standard: 0,70 CHF pro km</div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-3">
        <button type="submit" class="btn btn-primary">Arbeitsplatz speichern</button>
